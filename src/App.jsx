...
// LTA Logo — inline SVG component
function LTALogo({size}){var s=size||42;return <svg viewBox="0 0 600 600" width={s} height={s} style={{borderRadius:s*0.2}}>
<defs><linearGradient id="lbg" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stopColor="#0B1520"/><stop offset="100%" stopColor="#0D1B2A"/></linearGradient>
<linearGradient id="lac" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stopColor="#00D4AA"/><stop offset="100%" stopColor="#00B4D8"/></linearGradient>
<filter id="lg"><feGaussianBlur stdDeviation="4"/></filter></defs>
<rect width="600" height="600" rx="80" fill="url(#lbg)"/>
<g opacity="0.06"><line x1="100" y1="30" x2="100" y2="570" stroke="#00D4AA" strokeWidth="0.5"/><line x1="200" y1="30" x2="200" y2="570" stroke="#00D4AA" strokeWidth="0.5"/><line x1="300" y1="30" x2="300" y2="570" stroke="#00D4AA" strokeWidth="0.5"/><line x1="400" y1="30" x2="400" y2="570" stroke="#00D4AA" strokeWidth="0.5"/><line x1="500" y1="30" x2="500" y2="570" stroke="#00D4AA" strokeWidth="0.5"/><line x1="30" y1="200" x2="570" y2="200" stroke="#00D4AA" strokeWidth="0.5"/><line x1="30" y1="300" x2="570" y2="300" stroke="#00D4AA" strokeWidth="0.5"/><line x1="30" y1="400" x2="570" y2="400" stroke="#00D4AA" strokeWidth="0.5"/></g>
<path d="M 80 320 C 140 280,200 350,260 290 C 320 230,380 310,440 260 C 500 210,530 270,540 250" stroke="url(#lac)" strokeWidth="6" fill="none" strokeLinecap="round"/>
<circle cx="260" cy="290" r="5" fill="#00D4AA"/><circle cx="400" cy="284" r="4" fill="#00D4AA"/>
<rect x="155" y="220" width="28" height="70" rx="4" fill="#00D4AA" opacity="0.15" stroke="#00D4AA" strokeWidth="1"/><rect x="195" y="185" width="28" height="105" rx="4" fill="#00D4AA" opacity="0.2" stroke="#00D4AA" strokeWidth="1"/><rect x="235" y="140" width="28" height="150" rx="4" fill="url(#lac)" opacity="0.3" stroke="#00D4AA" strokeWidth="1.5"/><rect x="275" y="170" width="28" height="120" rx="4" fill="#00D4AA" opacity="0.2" stroke="#00D4AA" strokeWidth="1"/><rect x="315" y="200" width="28" height="90" rx="4" fill="#00D4AA" opacity="0.15" stroke="#00D4AA" strokeWidth="1"/>
<g transform="translate(380,155)"><circle cx="0" cy="0" r="50" fill="none" stroke="#00D4AA" strokeWidth="3" opacity="0.7"/><line x1="35" y1="35" x2="70" y2="70" stroke="#00D4AA" strokeWidth="4" strokeLinecap="round" opacity="0.7"/><line x1="-30" y1="-15" x2="30" y2="-15" stroke="#00D4AA" strokeWidth="1" opacity="0.3"/><line x1="-25" y1="0" x2="25" y2="0" stroke="#00D4AA" strokeWidth="1" opacity="0.3"/><line x1="-30" y1="15" x2="30" y2="15" stroke="#00D4AA" strokeWidth="1" opacity="0.3"/></g>
<text x="300" y="430" textAnchor="middle" fontFamily="'SF Pro Display','Helvetica Neue',Arial,sans-serif" fontSize="120" fontWeight="800" letterSpacing="18" fill="url(#lac)">LTA</text>
<text x="300" y="480" textAnchor="middle" fontFamily="'SF Pro Display','Helvetica Neue',Arial,sans-serif" fontSize="16" fontWeight="400" letterSpacing="8" fill="#8494A7">LOAN TAPE ANALYZER</text>
<line x1="60" y1="80" x2="100" y2="80" stroke="#00D4AA" strokeWidth="1.5" opacity="0.3"/><line x1="60" y1="80" x2="60" y2="120" stroke="#00D4AA" strokeWidth="1.5" opacity="0.3"/><line x1="500" y1="80" x2="540" y2="80" stroke="#00D4AA" strokeWidth="1.5" opacity="0.3"/><line x1="540" y1="80" x2="540" y2="120" stroke="#00D4AA" strokeWidth="1.5" opacity="0.3"/>
</svg>;}
...
async function aiMatch(hdrs,rows){var sample=hdrs.map(function(h){return h+": ["+rows.slice(0,4).map(function(r){return r[h];}).join(", ")+"]";}).join("\n");var fields=Object.keys(STD).map(function(k){return k+" ("+STD[k].l+")";}).join(", ");var body=JSON.stringify({model:"claude-sonnet-4-20250514",max_tokens:1500,messages:[{role:"user",content:"Map columns to ABS fields. Fields: "+fields+"\n\nColumns:\n"+sample+"\n\nReturn ONLY JSON {\"field_key\":\"Column_Name\",...}:"}]});try{var url="/.netlify/functions/anthropic-proxy";var res=await fetch(url,{method:"POST",headers:{"Content-Type":"application/json"},body:body});if(!res.ok){res=await fetch("https://api.anthropic.com/v1/messages",{method:"POST",headers:{"Content-Type":"application/json"},body:body});}var d=await res.json();var t=d.content.map(function(b){return b.text||"";}).join("");return JSON.parse(t.replace(/```json|```/g,"").trim());}catch(e){return{};}}
  ...
  return(
    <div style={{minHeight:"100vh",background:T.bg,fontFamily:"-apple-system,sans-serif",color:T.tx}}>
      ...
      <header style={{background:T.sf,borderBottom:"1px solid "+T.bd,padding:"0 18px",display:"flex",alignItems:"center",justifyContent:"space-between",height:42,position:"sticky",top:0,zIndex:50}}>
        <div style={{display:"flex",alignItems:"center",gap:8}}><LTALogo size={24}/><span style={{fontSize:12,fontWeight:700}}>Loan Tape Analyzer</span><span style={{fontSize:8,color:T.td}}>{fn}</span></div>
